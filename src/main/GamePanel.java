...
public class GamePanel extends JPanel implements Runnable{
    ...
    public void setPieces() {
        List<String> lines;
        try {
            lines = Files.readAllLines(Paths.get("E:\lichess_db_puzzle.csv"), StandardCharsets.UTF_8);
        } catch (IOException e) {
            e.printStackTrace();
            return;
        }
        ...
        String fen = lines.get(randomIndex);
    ...
    public void setPieces(String fen) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            for (int j = 0; j < row.length(); j++) {
                ...
                switch (piece) {
                    case 'p':
                        pieces.add(new Pawn(BLACK, 7 - i, j));
                        break;
                    case 'P':
                        pieces.add(new Pawn(WHITE, 7 - i, j));
                        break;
                    case 'r':
                        pieces.add(new Rook(BLACK, 7 - i, j));
                        break;
                    case 'R':
                        pieces.add(new Rook(WHITE, 7 - i, j));
                        break;
                    case 'n':
                        pieces.add(new Knight(BLACK, 7 - i, j));
                        break;
                    case 'N':
                        pieces.add(new Knight(WHITE, 7 - i, j));
                        break;
                    case 'b':
                        pieces.add(new Bishop(BLACK, 7 - i, j));
                        break;
                    case 'B':
                        pieces.add(new Bishop(WHITE, 7 - i, j));
                        break;
                    case 'q':
                        pieces.add(new Queen(BLACK, 7 - i, j));
                        break;
                    case 'Q':
                        pieces.add(new Queen(WHITE, 7 - i, j));
                        break;
                    case 'k':
                        pieces.add(new King(BLACK, 7 - i, j));
                        break;
                    case 'K':
                        pieces.add(new King(WHITE, 7 - i, j));
                        break;
                    default:
                        // Skip empty squares
